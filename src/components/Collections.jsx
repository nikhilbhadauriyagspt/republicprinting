      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-bold text-[#0096d6] capitalize tracking-[0.4em]">Core Pillars</span>
          </div>
          ...
          <div className="absolute inset-0 p-10 md:p-16 flex flex-col justify-end z-10">
            <div className="space-y-6">
              ...
              <h3 className="text-4xl md:text-6xl font-bold text-slate-950 capitalize  leading-none">
                Elite <br /><span className="text-[#0096d6] italic">Laptops.</span>
              </h3>
              ...
              <Link to="/shop?category=laptop-computers" className="inline-flex items-center gap-4 h-14 px-8 bg-slate-950 text-white rounded-2xl font-bold text-[10px] capitalize tracking-[0.2em] hover:bg-[#0096d6] hover:scale-105 transition-all shadow-xl shadow-black/10">
