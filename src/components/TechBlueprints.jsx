        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
          <div>
            <div className="flex items-center gap-3 mb-4">
              <span className="w-10 h-[2px] bg-[#0096d6]"></span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-1 bg-white border border-slate-100 overflow-hidden">
          ...
          >
            <div className="bg-white/90 backdrop-blur-md p-8 md:p-12 border-l-4 border-[#1447E6] max-w-lg">
              ...
              <Link
                to="/shop"
                className="inline-flex items-center gap-4 bg-slate-900 text-white px-8 py-4 font-bold text-xs uppercase tracking-widest transition-all hover:bg-[#0096d6] group/btn"
              >
                Shop the sale
          ...
          <PromoCard
            ...
            image={IMG.right}
          >
            <div className="bg-[#0096d6]/95 backdrop-blur-md p-8 md:p-12 border-l-4 border-white max-w-lg">
