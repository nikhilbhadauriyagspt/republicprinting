        ...
        <div className="flex items-end justify-between mb-16 gap-6">
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <Zap size={14} className="text-[#0096d6] fill-blue-600" />
              <span className="text-[10px] font-bold text-[#0096d6] capitalize tracking-[0.4em]">Recommended</span>
            </div>
            ...
            <SwiperSlide key={p.id}>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-[9px] font-bold text-[#0096d6] capitalize tracking-widest mb-1">{p.brand_name || 'Electronics'}</p>
                ...
                <button
                  ...
                  className={`h-10 w-10 rounded-2xl flex items-center justify-center transition-all shadow-lg ${cart.find(i => i.id === p.id) ? 'bg-[#0096d6]/200 text-white' : 'bg-slate-950 text-white hover:bg-[#0096d6] scale-0 group-hover:scale-100'}`}
                >
