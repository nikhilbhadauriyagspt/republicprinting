...
export default function OrderManager() {
  ...
  const statusColors = {
    ...
    delivered: 'bg-[#0096d6]/20 text-[#0096d6] border-emerald-100',
            ...
            >
              <div className="p-8 border-b border-gray-100 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[10px] font-bold text-[#0096d6] capitalize tracking-widest mt-1">#PFX-{selectedOrder.id}</p>
                </div>
                    ...
                    {Object.keys(statusColors).map((s) => (
                      <button
                        ...
                        className={`px-4 py-3 rounded-xl text-[9px] font-bold capitalize tracking-widest border transition-all ${selectedOrder.status === s
                          ? 'bg-[#0096d6] border-blue-600 text-white'
                                ...
                                return (
                                  <>
                                    ...
                                    <div className="flex justify-between">
                                      ...
                                      <span className="text-[9px] font-bold text-[#0096d6] capitalize">{details.status || 'COMPLETED'}</span>
                                    </div>
                                  </>
                                );
                              } catch (e) {
