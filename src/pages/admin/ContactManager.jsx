            ...
            <tbody className="divide-y divide-gray-50">
              {loading ? (
                ...
                <tr key={contact.id} className="hover:bg-gray-50/50 transition-colors group">
                  ...
                  <td className="px-8 py-6">
                    <span className={`px-3 py-1 rounded-full text-[9px] font-bold capitalize tracking-widest border ${contact.status === 'new' ? 'bg-blue-50 text-[#0096d6] border-blue-100' :
                      contact.status === 'read' ? 'bg-amber-50 text-amber-600 border-amber-100' :
                        'bg-[#0096d6]/20 text-[#0096d6] border-emerald-100'
                      }`}>
                      {contact.status}
                    </span>
                  </td>
            ...
            >
              <div className="flex items-center justify-between mb-10 pb-6 border-b border-gray-100">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] font-bold text-[#0096d6] capitalize tracking-widest mt-1">Status: {selectedContact.status}</p>
                  </div>
                </div>
              ...
              <div className="flex gap-4 pt-6 border-t border-gray-100">
                <button
                  ...
                  className="flex-1 h-14 bg-[#0096d6] text-white rounded-2xl flex items-center justify-center gap-3 text-[10px] font-bold capitalize tracking-widest hover:bg-black transition-all shadow-xl shadow-blue-600/20"
                >
                  <CheckCircle size={16} /> Mark as Replied
                </button>
                <a
                  href={`mailto:${selectedContact.email}`}
                  className="flex-1 h-14 bg-slate-900 text-white rounded-2xl flex items-center justify-center gap-3 text-[10px] font-bold capitalize tracking-widest hover:bg-[#0096d6] transition-all shadow-xl"
                >
