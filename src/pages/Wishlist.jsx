  ...
  if (wishlistCount === 0) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-white font-['Rubik'] text-center">
        ...
        <Link to="/shop" className="px-10 py-4 bg-[#0096d6] text-white font-bold text-[13px] uppercase tracking-widest hover:bg-[#0096d6]-hover transition-all rounded-full shadow-xl shadow-primary/20 active:scale-95">
              ...
              >
                ...
                <div className="relative aspect-square bg-[#F5F5F5] rounded-[24px] flex items-center justify-center overflow-hidden mb-5 border border-transparent transition-all group-hover:border-border group-hover:shadow-xl group-hover:shadow-black/5">
                  ...
                  <button
                    ...
                    className="absolute top-4 right-4 w-10 h-10 bg-white shadow-lg text-primary rounded-full flex items-center justify-center z-10 hover:bg-[#0096d6] hover:text-white transition-all active:scale-90"
                ...
                <div className="px-1 flex-1 flex flex-col">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-[10px] font-bold text-primary uppercase tracking-[0.2em] bg-[#0096d6]/5 px-2.5 py-1 rounded-full">{p.brand_name || 'HP Series'}</span>
                    <div className="h-1.5 w-1.5 rounded-full bg-[#0096d6]/200 shadow-[0_0_8px_rgba(16,185,129,0.5)]" />
                  </div>
                  ...
                  <div className="mt-auto pt-2 flex items-center justify-between gap-4">
                    ...
                    <button
                      onClick={() => addToCart(p)}
                      className="flex-1 h-11 bg-foreground text-white rounded-full flex items-center justify-center gap-2 text-[12px] font-bold uppercase tracking-widest hover:bg-[#0096d6] transition-all shadow-lg active:scale-95"
                    >
