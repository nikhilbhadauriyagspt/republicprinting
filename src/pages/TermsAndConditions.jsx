  ...
  return (
    ...
    >
      <section>
        ...
        <p>
          We are Dash Printer shop LLC ("Company," "we," "us," "our"), a company registered in California, United States at 78 Holland Ave, Morgantown, WV 26501, USA.

        </p>
        <p>
          We operate the website <a href="http://dashprintershop.com/">http://dashprintershop.com/</a> (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
        </p>
        <p>
          Dash Printer shop Solutions is your trusted destination for authentic, high-performance printers and printing accessories from HP and other leading technology brands.
        </p>
        <p>
          You can contact us by email at <a href="mailto:info@dashprintershop.com">info@dashprintershop.com</a>, or by mail to 78 Holland Ave, Morgantown, WV 26501, USA.
        </p>
        <p>
          These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and Dash Printer shop LLC, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. <strong>IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</strong>
        </p>
        <p>
      ...
      <section>
        ...
        <p>
          Please review our Return Policy prior to making any purchases: <a href="http://dashprintershop.com/return-policy">http://dashprintershop.com/return-policy</a>.
        </p>
      </section>
      ...
      <section>
        ...
        <div className="bg-gray-50 p-8 rounded-sm border border-[#e9e9e9] my-8 not-prose">
          <address className="not-italic text-gray-700 font-bold leading-relaxed space-y-2 capitalize ">
            <p className="text-black font-extrabold">Dash Printer shop LLC</p>
            <p>Direct Distribution</p>
            <p>78 Holland Ave, Morgantown, WV 26501, USA</p>
            <p>United States</p>
            <p className="pt-4 text-[#1447E6] font-extrabold lowercase">Email: info@dashprintershop.com</p>
          </address>
        </div>
      </section>
    </PolicyLayout>
